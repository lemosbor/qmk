...
[L_OSNOVA] = LAYOUT_ortho_5x15( \
  TD(KOP1),      TD(VST1),     KC_COMM,     VOPR,     KAVYCH, TD(VYH),  KC_SCLN,           KC_EQL,SLESH,OSKOB,     ZSKOB,       KC_MINS,  KC_DOT,   OTMENA,TD(SOHR), \
  ...
  CTL_T(KC_ESC),LGUI_T(KC_TAB),ALT_T(KC_F2),KC_BSPC,KC_SPC,OSM(MOD_LSFT),LT(L_DOP, KC_PDOT),KC_0,KC_LEFT,KC_DOWN,SFT_T(KC_RGHT),TD(RU_AN),TD(NACH),TD(KONE),ALTTABB \
),
