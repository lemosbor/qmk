...
[L_OSNOVA] = LAYOUT_ortho_5x15( \
  ...
  CTL_T(KC_ESC),LGUI_T(KC_TAB),ALT_T(KC_F2),KC_BSPC,KC_SPC,OSM(MOD_LSFT),LT(L_DOP, KC_PDOT),KC_0,KC_LEFT,KC_DOWN,SFT_T(KC_RGHT),TD(RU_AN),A_HOME,TD(KONE),ALTTABB \
),
