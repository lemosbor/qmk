...
TD(KOP1),	TD(VST1),	 KC_COMM,	VOPR,	KAVYCH,	ВЫХ,	KC_SCLN,	 SLESH, 	KC_EQL,	OSKOB,	ZSKOB,	KC_MINS,	KC_DOT,	TD(POISK),	TD(SOHR), \
KC_C,	KC_X,	KC_U,	KC_GRV,	KC_LBRC,	OTMENA,	KC_7,	KC_8,	KC_9,	KC_F,	KC_H,	KC_P,	KC_L,	KC_M,	KC_V, \
KC_I,	KC_A,	KC_E,	KC_O,	KC_S,	LGUI_T(KC_TAB),	KC_4,	KC_5,	KC_6,	KC_RBRC,	KC_K,	KC_N,	KC_T,	KC_W,	KC_R, \
KC_BSLS,	RU_E,	KC_Q,	KC_Y,	KC_NUBS,	KC_DEL, 	KC_1,	KC_2,	KC_3,	 TWZ, 	KC_G,	KC_D,	KC_B,	KC_Z,	KC_J, \
CTL_T(KC_ESC),	ALTTABB	ALT_T(KC_F2),	KC_BSPC,OSM(MOD_LSFT),KC_ENT,TD(RU_AN),KC_0,LT(L_DOP, KC_PDOT),	TD(KONE),	KC_SPC,	  KC_UP,	KC_DOWN,	KC_LEFT,	KC_RGHT \
),
[L_DOP] = LAYOUT_ortho_5x15( \
KC_TRNS,	KC_TRNS,	STEPE,	UMNO,	UDAR,	KC_TRNS,	KC_F10,	KC_F11,	KC_F12,	KK_LBRC,	KK_RBRC,	RU_TIR,	GRADU,	C(A(KC_DEL)),	PS_1, \
...
A(KC_F4),	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	 A(KC_F11),	C(KC_PGUP),	C(KC_PGDN),	KC_TRNS,	KC_PGDN,	G_SP,	KC_TRNS,	KC_TRNS,	KC_TRNS,	PS_5 \
)
}; 
