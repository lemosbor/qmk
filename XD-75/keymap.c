...
TD(KOP1), TD(VST1), TD(VYH), KC_COMM, VOPR, KAVYCH,  KC_SCLN,   SLESH,   KC_EQL, TD(OSKOBT),  TD(ZSKOBT),  TD(MINS),  KC_DOT, OTMENA,  TD(SOHR), \
...
KC_BSLS,  RU_E, KC_Q, KC_Y, KC_NUBS,  KC_DEL,   KC_1, KC_2, KC_3,  RU_TY,   KC_G, KC_D, KC_B, KC_Z, KC_J, \
