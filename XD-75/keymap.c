#include QMK_KEYBOARD_H //  qmk compile -kb xd75 -km leo 455
...
[L_OSNOVA] = LAYOUT_ortho_5x15( \
  TD(KOP1),      TD(VST1),TD(VYH),    KC_COMM,  VOPR,   KAVYCH, KC_SCLN,   KC_EQL,SLESH,  KC_MINS, OSKOB,   ZSKOB,    KC_DOT,  KC_BSPC,  TD(SOHR), \
