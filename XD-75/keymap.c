...
KC_LBRC,  KC_BSLS,  KC_X,  KC_Q,  RU_E,  KC_DEL, KC_1, KC_2, KC_3,  KC_H,  KC_P,  KC_G,  KC_R,  KC_M,  KC_B,  \
  TD(GIP),TD(VYDEL),ALT_T(KC_F2),OSM(MOD_LSFT),CTL_T(KC_SPC),  KC_ENT,LT(L_DOP, KC_PDOT),KC_0,TD(RU_AN), KC_BSPC, KC_SPC,   KC_UP,  KC_DOWN,  KC_LEFT,  KC_RGHT \
),
...
[L_PLOVER] = LAYOUT_ortho_5x15(
  TD(KOP1), TD(VST1), STN_N3,  STN_N4, STN_NA, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 				XXXXXXX, XXXXXXX, XXXXXXX, STN_N7,  STN_N8, XXXXXXX, \
