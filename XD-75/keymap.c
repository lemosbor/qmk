...
TD(KOP1), TD(VST1),  KC_COMM, VOPR, KAVYCH, TD(VYH),  KC_SCLN,   SLESH,   KC_EQL, OSKOB,  ZSKOB,  KC_MINS,  KC_DOT, OTMENA,  TD(SOHR), \
...
CTL_T(KC_ESC),  ALTTABB, ALT_T(KC_F2), KC_BSPC,OSM(MOD_LSFT),KC_ENT,LT(L_DOP, KC_PDOT),KC_0,TD(RU_AN), TD(KONE), KC_SPC,   KC_UP,  KC_DOWN,  KC_LEFT,  KC_RGHT \
),
...
A(KC_F4), KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   A(KC_F11), KC_TRNS, C(KC_PGUP), C(KC_PGDN),   KC_PGDN,  G_SP, KC_TRNS,  KC_TRNS,  KC_TRNS,  PS_5 \
)
}; 
