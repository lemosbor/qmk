...
KC_F,  KC_NUBS,  KC_I,  KC_Y,   KC_F15,   TD(POISK), KC_7, KC_8, KC_9,  KC_RBRC,  KC_J,   KC_Z,  KC_L,  KC_D,  KC_GRV,  \
KC_S,  KC_E,  KC_A,  KC_O,  KC_Q,  KC_TAB,   KC_4, KC_5, KC_6,  KC_C,  KC_V, KC_T,  KC_N,  KC_K,  KC_W,  \
KC_LBRC,  KC_BSLS,  KC_X,  KC_U,  KC_F14,  KC_DEL, KC_1, KC_2, KC_3,  KC_H,  KC_G,  KC_P,  KC_R,  KC_M,  KC_B,  \
...
PS_1, PS_2,  PS_3,  PS_4,  PS_5,   A(KC_F11), KC_TRNS, KC_TRNS, MET_PER,   KC_TRNS,  G_SP, KC_PGUP,  KC_PGDN, C(KC_PGUP),  C(KC_PGDN) \
),
}; 
