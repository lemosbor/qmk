...
[L_OSNOVA] = LAYOUT_preonic_grid( \
  ...
  KC_C,          KC_X,          KC_U,        KC_GRV,    KC_LBRC,  KC_BSPC, KC_F,    KC_H,    KC_P,      KC_L,     KC_M,     KC_V, \
  ...
  CTL_T(KC_ESC), LGUI_T(KC_TAB),ALT_T(KC_F2),TD(POISK), KC_SPC,   KC_LEFT, KC_DOWN,SFT_T(KC_RGHT),OSL(L_DOP),TD(RU_AN),OTMENA,TD(TABB) \
),
[L_DOP] = LAYOUT_preonic_grid( \
  RGB_TOG,      RGB_MOD,        S(KC_5),     STEPE,     UDAR,     S(KC_4), KC_F10,  KC_F11,  KC_F12,    KC_PAST,  KK_LBRC,  KK_RBRC, \
