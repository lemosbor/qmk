...
[L_OSNOVA] = LAYOUT_preonic_grid( \
  TD(KOP1),     TD(VST1),TD(VYH), KC_COMM,    VOPR, KAVYCH, KC_SCLN,       SLESH,     KC_MINS,KC_DOT, OSKOB,  ZSKOB, \
  ...
  KC_BSLS,      RU_E,    KC_Q,       KC_Y,          KC_NUBS,KC_DEL,        TD(RU_AN),    KC_G,   KC_D,  KC_B,   KC_Z,   KC_J, \
  ALTTABB,KC_BSPC,ALT_T(KC_F2),OSM(MOD_LSFT),CTL_T(KC_SPC),  KC_ENT,  LT(L_DOP, KC_END),KC_SPC, KC_UP, KC_DOWN,KC_LEFT,KC_RGHT \
),
[L_DOP] = LAYOUT_preonic_grid( \
  RGB_TOG,      RGB_MOD,       S(KC_4), S(KC_5),     KC_EQL,     S(KC_2),   KC_F10,  KC_F11,  KC_F12,    KC_PAST,  KK_LBRC,  KK_RBRC, \
  KC_NUMLOCK,   RU_TY,          KC_TRNS,     KC_RESET,   KC_PSCR,  KC_TRNS, KC_F7,   KC_F8,   KC_F9,     KC_7,     KC_8,     KC_9, \
  ...
  KC_TRNS,     PS_1,           PS_2,        KC_TRNS, C(KC_PGUP),C(KC_PGDN),KC_TRNS, G_SP,  KC_PGUP,   KC_PGDN,  KC_0,     KC_PDOT \
)
}; 
