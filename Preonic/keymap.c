...
[L_OSNOVA] = LAYOUT_preonic_grid( \
  ...
  KC_BSLS,       RU_E,          KC_Q,        KC_Y,          KC_NUBS,KC_DEL,  KC_UP,   KC_G,    KC_D,      KC_B,     KC_Z,     KC_J, \
  CTL_T(KC_ESC), LGUI_T(KC_TAB),ALT_T(KC_F2),SFT_T(KC_BSPC),KC_SPC,KC_LEFT,  KC_DOWN,KC_RGHT,OSL(L_DOP),TD(RU_AN), OTMENA, ALTTABB \
),
[L_DOP] = LAYOUT_preonic_grid( \
  ...
  KC_TRNS,      KC_BRID,        KC_BRIU,     C(S(KC_ESC)),KC_TRNS,KC_PGUP, KC_F1,   KC_F2,   KC_F3,     KC_1,     KC_2,     KC_3, \
  A(KC_F4),     PS_1,           KC_TRNS,     UD_STROK,  G_SP,     KC_HOME, KC_PGDN, KC_END,  KC_TRNS,   KC_PDOT,  KC_0,     KC_TRNS \
)
}; 
